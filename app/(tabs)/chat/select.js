...
const select = () => {
  ...
  const handleMatch = async (selectedUserId) => {
    try {
      await axios.post("https://datingclone-backend.onrender.com/create-match", {
    ...
    <ScrollView style={{ backgroundColor: "white", flex: 1, padding: 10 }}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 14 }}>
        ...
        <View
          style={{ backgroundColor: "#F0F0F0", padding: 10, borderRadius: 18 }}
        >
          <Text style={{ textAlign: "center" }}>Looking for 💓</Text>
        </View>
        <View
          style={{ backgroundColor: "#F0F0F0", padding: 10, borderRadius: 18 }}
        >
          <Text style={{ textAlign: "center" }}>Turn-Ons 💌</Text>
        </View>
      </View>
      {profiles?.length > 0 ? (
